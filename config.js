...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~XXWG7r5y",
  MENU_URL: process.env.MENU_URL || "https://telegra.ph/file/3eb3c99af0e72e58c7b65.jpg",
  CAPTION: process.env.CAPTION || "𝙍𝙚𝙢𝙤🍉🦋",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "Eypz God",
  BOT_NAME: process.env.BOT_NAME || "𝐀𝐜𝐡𝐮𝐭𝐭𝐲🍉🦋",
  SUDO: process.env.SUDO || "917034679660,919656650369",
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || " 𝐀𝐜𝐡𝐮𝐭𝐭𝐲,❤️",
  ...
  AUTHOR: process.env.AUTHOR || " 𝐀𝐜𝐡𝐮𝐭𝐭𝐲🍉🦋",
